...
public class SerializationsTest extends AbstractSerializationsTester
{
    ...
    private static class Statics
    {
        ...
        private final SortedSet<CellName> NamedCols = new TreeSet<CellName>(CellNames.simpleDenseType(BytesType.instance))
        {{
        ...
        private final SortedSet<CellName> NamedSCCols = new TreeSet<CellName>(CellNames.compositeDenseType(BytesType.instance, BytesType.instance))
        {{
