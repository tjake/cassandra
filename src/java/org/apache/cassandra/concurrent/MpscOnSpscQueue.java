...
/**
 * Use an SPSC per producer. (from JCTools-experimental (not yet released))
 */
...
abstract class MpscOnSpscFields<E> extends MpscOnSpscL0Pad<E> {
    ...
    private final Thread weakRefProcessor;
    ...
    public MpscOnSpscFields(final int capacity) {
        ...
        weakRefProcessor.setDaemon(false);
        weakRefProcessor.start();
        queues = new Queue[0];
    }

    public Thread getRefProcessorThread()
    {
        return weakRefProcessor;
    }
