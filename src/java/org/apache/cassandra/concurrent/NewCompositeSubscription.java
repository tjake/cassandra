 ...
 */
public class NewCompositeSubscription implements Subscription
{
    private Set<Subscription> subscriptions;
    private AtomicBoolean unsubscribed = new AtomicBoolean(false);

    public NewCompositeSubscription() {
    }

    public NewCompositeSubscription(final Subscription... subscriptions) {
