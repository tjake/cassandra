...
public class RequestThreadPoolExecutor extends AbstractEventExecutor
{
    ...
    private final TracingAwareExecutorService wrapped = new MonitoredExecutiveService("transport", DatabaseDescriptor.getNativeTransportMaxThreads(), MAX_QUEUED_REQUESTS);
