...
public class TestFormat implements SSTableFormat
{
    ...
    {
        return new TestTablePartitionIterator(in, flag, expireBefore, cfm);
    }
    ...
    {
        return new TestTableWriter.TestCompactedRowWriter(controller, onDiskAtomIterators);
    }
    ...
    private static class ReaderFactory extends SSTableReader.Factory
    {
        ...
        {
            return new TestTableReader(descriptor, components, metadata, partitioner, maxDataAge, sstableMetadata, openReason);
        }
    }
