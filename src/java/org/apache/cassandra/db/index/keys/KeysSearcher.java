...
public class KeysSearcher extends SecondaryIndexSearcher
{
                                                ...
                                                boolean isForThrift)
    {
        if (isForThrift)
        {
            ...
            return deleteIfStale(iterator.partitionKey(), cell, index, indexHit, indexedValue, writeOp, iterator.nowInSec())
                 ? null
        ...
        else
        {
            ...
            if (deleteIfStale(iterator.partitionKey(), cell, index, indexHit, indexedValue, writeOp, iterator.nowInSec()))
            {
                iterator.close();
                return null;
            }
