...
public class CompactionStrategyManager implements INotificationConsumer
{
    ...
    public synchronized AbstractCompactionStrategy.ScannerList getScanners(Collection<SSTableReader> sstables, Range<Token> range, int nowInSec)
    {
        ...
        AbstractCompactionStrategy.ScannerList repairedScanners = repaired.getScanners(repairedSSTables, range, nowInSec);
        AbstractCompactionStrategy.ScannerList unrepairedScanners = unrepaired.getScanners(unrepairedSSTables, range, nowInSec);
    ...
    public synchronized AbstractCompactionStrategy.ScannerList getScanners(Collection<SSTableReader> sstables, int nowInSec)
    {
        return getScanners(sstables, null, nowInSec);
    }
