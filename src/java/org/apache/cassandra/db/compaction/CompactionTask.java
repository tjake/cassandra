...
public class CompactionTask extends AbstractCompactionTask
{
    ...
    protected void runMayThrow() throws Exception
    {
        ...
        try (CompactionController controller = getCompactionController(transaction.originals()))
        {
            ...
            try (AbstractCompactionStrategy.ScannerList scanners = strategy.getScanners(actuallyCompact, FBUtilities.nowInSeconds());
                 CompactionIterator ci = new CompactionIterator(compactionType, scanners.scanners, controller, taskId))
            {
                if (collector != null)
