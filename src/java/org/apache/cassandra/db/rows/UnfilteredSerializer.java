...
public class UnfilteredSerializer
{
    ...
    throws IOException
    {
        ...
        UnfilteredRowIteratorSerializer.writeDelTime(marker.deletionTime(), header, out);
    }
    ...
    public long serializedSize(RangeTombstoneMarker marker, SerializationHeader header, int version, TypeSizes sizes)
    {
        return 1 // flags
             ...
             + UnfilteredRowIteratorSerializer.delTimeSerializedSize(marker.deletionTime(), header, sizes);
    }
    ...
    throws IOException
    {
        ...
        StaticRow.Builder builder = StaticRow.builder(header.columns().statics, true, helper.nowInSec, header.columns().statics.hasCounters());
    ...
    throws IOException
    {
        writer.writeMarkerDeletion(UnfilteredRowIteratorSerializer.readDelTime(in, header));
        writer.endOfMarker();
    }
